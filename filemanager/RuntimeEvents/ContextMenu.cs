namespace filemanager
{
    public partial class Manager
    {
        private void InitContextEvents()
        {
            ...
            addQuickToolContext.Click      += (sender, e) => Controllers["QuickAccessAdd"].PerformClick();
            contextQuickAccessRemove.Click += (sender, e) => Controllers["QuickAccessRemove"].PerformClick();
        }
